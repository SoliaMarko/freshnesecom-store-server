...
export class ProductService {
  ...
  async getProducts(page: number, itemsPerPage: number): Promise<PaginatedDTO<ProductResponseType>> {
    const {products, itemsCount} = await this.repository.getProducts(page, itemsPerPage);
